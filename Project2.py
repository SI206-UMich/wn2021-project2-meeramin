...
#Name: meera amin
#Who I worked with: Ria Dubey  
#Email: meeramin@umich.edu
#UMID: 2214 7406
...
def get_search_links():
    ...
    """
    req = requests.get("https://www.goodreads.com/search?q=fantasy&qid=NwUsLiA2Nc")
    soup = BeautifulSoup(req.text, 'html.parser')
    sr = soup.find_all('a', class_="bookTitle")
    li = []
    count = 0
    for a in sr:
        if count == 10:
        ...
        li.append("https://www.goodreads.com" + a.get('href'))
        count += 1
